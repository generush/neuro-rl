...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Load LSTM model and set data path.")
    parser.add_argument("--model_path", type=str, help="Path to the LSTM model file.")
