...
def run_analysis():
    ...
    # Append pc data
    avg_cycle_df, pca_dict = append_pc(avg_cycle_df, cfg.dataset_names, cfg.max_num_principal_components, cfg.normalization_type, cfg.data_paths.output)

    # Append tangling data
    avg_cycle_df = append_tangling(avg_cycle_df, cfg.dataset_names, cfg.tangling_type)

    # Append speed axis
    avg_cycle_df = append_speed_axis(avg_cycle_df, cfg.dataset_names, cfg.max_num_principal_components, cfg.normalization_type, cfg.data_paths.output)
    ...
    plot_pc12_speed_axis(avg_cycle_interp_df, cfg.dataset_names, cfg.data_paths.output)
