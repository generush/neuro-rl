...
python ../../../../IsaacGymEnvs/isaacgymenvs/train.py task=bash_AnymalTerrain_NeuroRL_exp \
  ...
  task.env.specifiedCommandVelocityN.n_copies=20 \
  task.env.output.export_data=True \
  task.env.evaluate.perturbPrescribed.perturbPrescribedOn=False \
  task.env.evaluate.perturbPrescribed.forceY=0. \
