...
def plot_csv_with_offset(csv_file, offset, start_index, stop_index, baseline_start_index, baseline_stop_index, alpha=1.0, save_file=None):
    ...
    colors = ['b', 'b', 'b', 'b', 'b', 'r', 'r', 'r', 'r', 'r','g', 'g', 'g', 'g', 'g']
...
csv_file = '/home/gene/Desktop/frontiers2023/gradients_hc.csv'  # Change this to your overlay CSV file
offset_value = -0.25  # Adjust the overlay offset value as needed
